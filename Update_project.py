...
print("""
        <div class="flex-fill" id="first_content_box">
            ...
            <div id="Secount_continer_box">
                ...
                <div class="container-fluid" id="update_project_status"><!--update_project_status-->

                    <div class="row" >
                       <div class="col-sm-5"></div>
                       <div class="col-sm-3" style="border: 2px solid white; background-color: white; border-radius: 2px; box-shadow:0px 0px 10px gray; border-radius: 5px;" >
                           <form method="post" enctype="multipart/form-data">
                               <h3 style="text-align: center; font-weight: bolder; text-decoration: none;" > Update Project Status</h3>
                               <div class="form-group">
                                   <div class="input-group">
                                       <div class="input-group-addon" ><i class="fa fa-list"></i></i></div> 
                                   <input type="number" name="pid" id="pid" class="form-control" value="%s" >
                               </div>
                               </div>
                               ...
                               <div class="form-group">
                                   ...
                                   <input type="date"  required name="date_of_Completion"   class="form-control" id="date_of_Completion">
                               </div>
                               </div>
                               <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="file" name="Source_code" id="Source_code" class="form-control" required>
                                </div>
                               </div>

                               <div class="closes"  >
                                   <input type="submit" name='update' value="Update" class="btn btn-success form-control" style="margin-top: 10px;">
...
if update!=None:
    ...
    date=form.getvalue('date_of_Completion')
    pid=form.getvalue('pid')
    if Source_code.filename:
        fns = os.path.basename(Source_code.filename)
        open("dbmedia/" + fns, "wb").write(Source_code.file.read())

    Q="""update project set Sourec_code='%s',Date_of_Completcompletion='%s',Status='Finished' where PID='%s'"""%(fns,date,pid)
    cur2.execute(Q)
    con2.commit()
    print("""<script>
    location.href="Tech_Existingproject.py?id=%s"
    </script>"""%ID)