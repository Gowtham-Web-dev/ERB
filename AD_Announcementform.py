...
#Announcement_Form{
    border: 2px solid white;
     ...
     border-radius: 2px; 
     box-shadow:0px 0px 8px gray; border-radius: 5px; 
}
        ...
        <div class="flex-fill" id="first_content_box">
            ...
            <div class="container-fluid d-none d-lg-block d-xl-block " id="Dashbord_Head" ><!--Time-->
             ...
             <div id="Secount_continer_box">
                        ...
                        <div class="container-fluid" id="Announcements"><!--Announcement form-->
                            <div class="row">
                             <div class="col-sm-4"></div>
                             <div class="col-sm-3" id="Announcement_Form">
                                 <form method="post" enctype="multipart/form-data" name="Announcement">
                                     <h2 style="text-align: center; font-weight: bolder;" ><i class="fa fa-bell" style="color: rgb(190, 190, 15);"></i> Announcement</h2>
                                     <div class="form-group"><!--Depaterment-->
                                     ...
                                     <div class="form-group"> <!--Message-->
                                       <i class="fa fa-message" style="color:#009d63;"></i>  <label for="">Message</label>
                                     <textarea required name="Message" id="" cols="20" rows="4" class="form-control" placeholder="Type Now"></textarea>
                                     </div>
...
if send !=None:
    ...
    cur2 = con2.cursor()
    Q="""INSERT INTO announcement(depatment,role,subject,message,Declarer)
     VALUES ('%s','%s','%s','%s','%s')"""%(Department,Designation,Subject,Message,'Admin')
    cur2.execute(Q)
    con2.commit()
    print("""<script>alert("Announcement Send")</script>""")
