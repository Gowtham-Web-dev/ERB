...
####invoice tabel
    ...
    cur=con.cursor()
    q="""select * from invoice where Status='approved' And EID='%s'"""%ID
    cur.execute(q)
    rec1=cur.fetchall()
if role=='Manager':
    con = pymysql.connect(host="localhost", user="root", password="", database="erp")
    cur = con.cursor()
    q = """select * from invoice where Status='approved'"""
    cur.execute(q)
    rec1 = cur.fetchall()
print("""<!DOCTYPE html>
<html lang="en">
            ...
            <div id="Secount_continer_box">
                      <div class="row">
                        <div class="col-md-2"></div>
                            <div class="col-md-10">
                             <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);">Existing Invoice</h3>
                                <table class="table">
                                    <thead>
                                    <th>CID</th>
                                    <th>Invoice No</th>
                                    ...
                                    <tbody>""")
for J in rec1:
    f = "xampp/htdocs/ERP/dbmedia/" + J[15]
    print("""
                                            <tr>
                                            ...
                                            """ % (J[0], J[12], J[1], J[4], J[6], J[7], J[8], f,J[18],J[16]))
print("""
                                    </tbody>
                                </table>
