...
cur3=con3.cursor()
Q="""select * from salaty_table where EID='%s'"""%ID
cur3.execute(Q)
rec2=cur3.fetchall()
print("""<!DOCTYPE html>
<html lang="en">
...
print("""
                <div id="Sidebar" class="d-flex flex-column  offcanvas-md offcanvas-start " >
                   <div>
                    ...
                    <li><a href="./Tech_salarytable.py?id=%s" target="_self" id="a" style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;"><span class=" fa fa-money-bill-1-wave" style="color: #CFEEFF;"></span>Salary</a></li>
                    <li><div class="dropdown">
...
print("""
        ...
        <div class="flex-fill" id="first_content_box">
            ...
            <div id="Secount_continer_box">
                <div class="container-fluid" id="salarys"><!--salary table-->
                    <div class="row">
                    <div class="col-md-2"></div>
                    <div class="col-md-10">
                    <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);">Salary  Details</h3>
                    <table class="table">
                            <tr>
                                <thead>
                                <th>Year</th>
...
for j in rec2:
    ...
    print("""
         ...
         """ % (j[5],j[4], j[12], j[6], j[7], j[8], j[9], j[10], j[11],issue_date1))
    print("""
