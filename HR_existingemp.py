...
cur=con.cursor()
#######
q1="""select * from employee1 where status='%s'"""%('approved')
cur.execute(q1)
rec1=cur.fetchall()
print("""<!DOCTYPE html>
<html lang="en">
...
print("""
            <div id="Secount_continer_box">
                <div class="container-fluid" id="Employees_table"> <!--Employee Table-->
                    ...
                    <div class="col-md-10">
                    <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);">Employee Details</h3>
                    <table class="table" >
...
for j in rec1:
    ...
    print("""
                        ...
                        <form   method="post" enctype="multipart/form-data">
                            <td><input type="text"required name="ID" value="%s" readonly style="border:none;"></td>
                            <td>%s</td>
                            <td>%s</td>
                            <td>%s</td>
                            <td>%s</td>
...
if view !=None:
    Id=form.getvalue("ID")
    print("""<script>
          location.href="card.py?ID=%s&id=%s"
        </script>
        """ %(ID,Id))