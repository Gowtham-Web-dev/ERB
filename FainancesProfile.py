...
print("""
        ...
        <div id="Sidebar" class="d-flex flex-column  offcanvas-md offcanvas-start " >
           <div>
            ...
            <li><a href="./FainancesProfile.py?id=%s" id="a" style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;"><span class="fa fa-user-circle" style="color: #CFEEFF;"></span> Profile </a></li>
...
print("""
                                    ...
                                    <form method="post" enctype="multipart/form-data" id="newprofile">
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="submit" required name="updateprofile" class="btn btn-info" style="margin: 0px 0px 20px;text-align: right;" >
                                            </form>
                                            </div>
                                    </div>
