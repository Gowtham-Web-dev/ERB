...
if i[10] == 'Manager':
    q3="""select *from announcement2 where  EID=%s"""%ID
    cur2.execute(q3)
    rec1=cur2.fetchall()
    #q4="""select *from announcement where role='%s' and depatment='%s'"""%(i[10],'All')
    #cur2.execute(q4)
    #cur2.execute(q4)
    #rec2=cur2.fetchall()
elif i[10]=='JavaDeveloper':
    q3="""select *from announcement2 where  EID=%s"""%ID
    cur2.execute(q3)
    rec1 = cur2.fetchall()
    # q4 = """select *from announcement where role='%s' and depatment='%s' and status='%s'""" % ('All', i[8], 'new')
    # cur2.execute(q4)
    # rec2 = cur2.fetchall()
    # q5 = """select *from announcement where role='All' and depatment='All' and status='new'""";
    # cur2.execute(q5)
    # rec3 = cur2.fetchall()
    # rec1 = cur2.fetchall()
elif i[10]=='PythonDeveloper':
    q3="""select *from announcement2 where  EID=%s"""%ID
    cur2.execute(q3)
    rec1 = cur2.fetchall()
    # q4 = """select *from announcement where role='%s' and depatment='%s' and status='%s'""" % ('All',i[8],'new')
...
print("""
            ...
            <li><div class="dropdown">
                <a data-toggle="dropdown"  id="op"><span class="fa fa-diagram-project"></span>Project<span class="caret" style="margin-top: 10px;"></span></a>
                <ul class="dropdown-menu">
...
print("""
        <div class="flex-fill" id="first_content_box">
            ...
            <div id="Secount_continer_box">
                       ...
                       <div class="container-fluid" id="Personal_Announcements"> <!--Personal Announcement-->
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-10">
                                <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);">Existing Announcement </h3>
                            <table class="table">
                                <thead><tr>
