           ...
           <div>
            ...
            <li><div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="./FN_ExpencessVendor.py?id=%s">Existig Vendor Expenses<span class></span></a></li>
          ...
          <div id="Secount_continer_box">
            <div class="row"> 
                        ...
                        <div class="col-md-4">
                                ...
                                <h4 style="text-align: center; padding: 5px;">Total Expenses</h4>
                          ...
                          <div class="col-sm-4">
                            <div style=" width: 25rem; background-color: #CCCCFF; border-radius: 10px; color: #800080;">
                                ...
                                <h4 style="text-align: center; padding: 5px;">Monthly Expenses</h4>
                                <i style="font-size:xx-large;padding: 10px;"><i class="fa fa-money-bill" style="background-color: #fff; padding: 20px; border-radius: 120px; color: #23395f;margin:0px 0px 20px 0px"></i><i>%s</i></i>
                                </div>
                        </div>
                     </div>
               ...
               <div class="col-md-10">
               <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);"> Vendor Expenses</h3>
               <table class="table">
               <thead>
               <tr>
               <th>Year</th>
