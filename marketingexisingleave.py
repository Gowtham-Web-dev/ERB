           ...
           <div>
            ...
            <h3 class="Profile">Personal</h3>
              ...
              <li><div class="dropdown">
                <a data-toggle="dropdown"  id="op"id="op" style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;"><span class="fa fa-bell"  style="color: #CFEEFF;" ></span>Leave<span class="caret" style="margin-top: 10px;"></span></a>
