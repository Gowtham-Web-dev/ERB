...
cur2=con1.cursor()
if i[10]=='Manager':
    q1="""select * from project where Status='Assigned'"""
    cur2.execute(q1)
    rec1= cur2.fetchall()
    print("""<style>
    #b1{
    ...
    q1 = """select * from project where Status='Assigned' and Team='%s'"""%i[10]
    cur2.execute(q1)
    rec1 = cur2.fetchall()
    print("""<style>
    #a1{
...
print("""
        <div class="flex-fill" id="first_content_box">
            ...
            <div id="Secount_continer_box">
                ...
                <div class="container-fluid" id="New_projects_table"><!--New priject table-->
                    <div class="row">
                        <div class="col-md-2"></div>
                        <div class="col-md-10">
                        <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);">New Project's </h3>
                    <table class="table" >
                        <thead>
                            <tr>
                                <th>PID</th>
...
for a in rec1:
    print("""
                            ...
                            <form method="post" enctype="multipart/form-data">
                              ...
                              <td>%s</td> 
                              <td id="a1">%s</td>   
                              <td id="b1"><input type="submit"  name="accept" value="accept" class="btn btn-sm btn-info"></td>  
                            </tr>
                            </form>
...
if accept !=None:
    ...
    cur = con.cursor()
    q1 = """update project set Status='accept' where PID='%s'"""%(PID)
    cur.execute(q1)
    con.commit()
    print("""<script>alert("Project Accepted")</script>""")