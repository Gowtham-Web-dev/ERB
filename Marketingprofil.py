                ...
                <div id="Sidebar" class="d-flex flex-column  offcanvas-md offcanvas-start " >
                   <div>
                    ...
                    <h3 class="Profile">Personal</h3>
                      <li><a href="./Marketingprofil.py?id=%s"" id="a" id="op" style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;"><span class="fa fa-user-circle"  style="color: #CFEEFF;" ></span> Profile </a></li>
