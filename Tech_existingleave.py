                ...
                <div id="Sidebar" class="d-flex flex-column  offcanvas-md offcanvas-start " >
                   <div>
                    ...
                    <h3 class="Profile">Personal</h3>
                      <li><a href="./Tech.py?id=%s"id="a"><span class="fa fa-user-circle"  ></span> Profile </a></li><li><div class="dropdown">
...
print("""
        ...
        <div class="flex-fill" id="first_content_box">
            ...
            <div id="Secount_continer_box">
                ...
                <div class="container-fluid" id="Existin_Leaves" ><!--Existing leave table-->
                    <div class="row"><!--search-->
                       ...
                       <div class="col-sm-8" style="display: flex;"> 
                           <div class="form-group" style="margin-top: 2px; width: 100%;">
                               ...
                               <input type="search" name="search"  placeholder="Search for year " class="form-control" id="search">
                           </div>
                           </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                        <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);">Existing Leave </h3>
                   <table class="table">
                       <thead>
                           <tr>
                           <th>Month</th>
