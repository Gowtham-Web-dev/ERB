...
if i[10] == 'Manager':
    ...
    #q4 = """select *from announcement where role='%s' and depatment='%s'""" % ('All',i[8])
    #cur2.execute(q4)
    #rec2 = cur2.fetchall()
print("""<!DOCTYPE html>
<html lang="en">
...
print("""
                ...
                <div id="Sidebar" class="d-flex flex-column  offcanvas-md offcanvas-start " >
                   <div>
                    ...
                    <li><div class="dropdown">
                        <a data-toggle="dropdown"  id="op" id="op" style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;"><span class="fa fa-bell"  style="color: #CFEEFF;" ></span>Announcement<span class="caret" style="margin-top: 10px;"></span></a>
                        <ul class="dropdown-menu">
