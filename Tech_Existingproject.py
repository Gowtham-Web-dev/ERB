...
cur2=con1.cursor()
if i[10]=='Manager':
    q1="""select * from project where Status='accept'"""
    cur2.execute(q1)
    rec1= cur2.fetchall()
    print("""<style>
        #b1{
    ...
    q1 = """select * from project where Status='accept' and Team='PythonDeveloper'"""
    cur2.execute(q1)
    rec1 = cur2.fetchall()
    print("""<style>
        #a1{
...
cur3=con1.cursor()
if i[10]=='Manager':
    Q1="""select * from project where Status='Finished'"""
    cur3.execute(Q1)
    record= cur3.fetchall()

else:
    Q1 = """select * from project where Status='Finshed' and Team='PythonDeveloper'"""
    cur3.execute(Q1)
    record = cur3.fetchall()
print("""<!DOCTYPE html>
<html lang="en">
...
print("""
            ...
            <h3 class="Profile">Personal</h3>
              ...
              <li><div class="dropdown">
                ...
                <ul class="dropdown-menu">
                     <li><a href="./Tech_leaveform.py?id=%s" target="_self">New <span class="fa  fa-plus"></span></a></li>
                    <li><a href="./Tech_existingleave.py?id=%s" target="_self"> Existing </a></li>
                </ul>
            </div>
            </li>
            <li><a href="./Tech_salarytable.py?id=%s" target="_self" id="a"><span class=" fa fa-money-bill-1-wave"></span>Salary</a></li>
            <li><div class="dropdown">
                <a data-toggle="dropdown"  id="op"><span class="fa fa-bell"></span>Announcement<span class="caret" style="margin-top: 10px;"></span></a>
                <ul class="dropdown-menu">
                     <li><a href="./Tech_Announcement.py?id=%s" target="_self">New <span class="fa  fa-plus"></span></a></li>
                    <li><a href="./Tech_Announcement2.py?id=%s" target="_self"> Existing </a></li>
                </ul>
            </div>
            </li>
    ...
    <li><div class="dropdown">
        <a data-toggle="dropdown"  id="op" style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;"><span class="fa fa-diagram-project" style="color: #CFEEFF;"></span>Project<span class="caret" style="margin-top: 10px;"></span></a>
        <ul class="dropdown-menu">
             <li><a href="./Tech_newProject.py?id=%s" target="_self">New <span class="fa  fa-plus"></span></a></li>
            <li><a href="./Tech_Existingproject.py?id=%s" target="_self">  Existing </a></li>
        </ul>
    </div>
    </li>
...
print("""
        <div class="flex-fill" id="first_content_box">
            ...
            <div class="container-fluid d-none d-lg-block d-xl-block " id="Dashbord_Head" ><!--Time-->
                <i class="text-info" style="margin: 220px;">Technical Dash Bord</i>
                <div id="Logout_TIME">
                <li id="time"></li>
            ...
            <div id="Secount_continer_box">
                ...
                <div class="container-fluid" id="work_porjects_table"><!--work progect table-->
                    <div class="row">
                        <div class="col-md-2"></div>
                        <div class="col-md-10">
                        <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);">Working Project </h3>
                    <table class="table">
                        <thead style="background:linear-gradient(#000133,#0f0f0f); color: white; border-radius: 10px;">
                            <tr>
                                <th>PID</th>
                                <th>Project Type</th>
                                <th>Language</th>
...
for a in rec1:
    print("""
                            ...
                            <form method="post" enctype="multipart/form-data">
                              <td><input type="number" name="PID" readonly style="border:none; width:35px" value="%s"></td>  
                              <td>%s</td>  
                              <td>%s</td>  
                              <td>%s</td>  
                              <td>%s</td>  
                              <td>%s</td>
                              <td id="a1">%s</td>    
                              <td id="b1"><input type="submit"  name="Update" value="Update" class="btn btn-sm btn-info"></td>  
                            </tr>
                            </form>
"""%(a[0],a[11],a[5],a[4],a[18],a[6],a[15]))
print("""
                ...
                <div class="container-fluid" id="finish_porjects_table"><!--fisnh progect table-->
                    <div class="row">
                        <div class="col-md-2"></div>
                        <div class="col-md-10">
                   <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);">Finished Project's</h3>
                    <table class="table">
...
for b in  record:
    ...
    print("""                  <tr>
                            ...
                            """%(b[0],b[11],b[5],b[4],b[18],b[7],b[8],b[7],b[15],sour))
print("""
                        </tbody>
                    </table></div>
                </div>
...
if Update !=None:
    ...
    print("""<script>
              location.href="Update_project.py?id=%s&PID=%s"
            </script>
            """ % (ID,PID))