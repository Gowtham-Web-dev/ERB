...
print("""
        <div class="flex-fill" id="first_content_box">
            ...
            <div id="Secount_continer_box">
                <div class="container-fluid" id="Existing_Leaves_HR"><!--Existing_Leave_IN HR-->
                   <div class="row">
                    <div class="col-md-2 d-none d-lg-block d-xl-block"></div>
                    <div class="col-md-10">
                    <h3 style="font-family: verdana;font-weight: bold;font-size: 20px;color: rgb(0, 208, 255);">Existing Leave Request</h3>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>EmployeeId</th>
...
for j in rec1:
    print("""
                            ...
                            """%(j[1],j[2],j[3],j[4],j[5],j[6],j[7],j[8],j[12],j[10]))
print("""
                        </tbody>
                    </table>
                </div>
