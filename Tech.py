        ...
        <div id="Sidebar" class="d-flex flex-column  offcanvas-md offcanvas-start " >
           <div>
            ...
            <h3 class="Profile">Personal</h3>
               <li><a href="./Tech.py?id=%s"id="a"style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;"><span class="fa fa-user-circle" style="color: #CFEEFF;" ></span> Profile </a></li>
                ...
                <div id="Secount_continer_box">
                    <div class="container-fluid"> <!-- model in profile-->
                        <div class="row">
                            ...
                            <div class="col-md-2">
                            <div class="s" style="width: 350px; background-color: white; height: max-content;"  >
                                <div class="main">
                                    <div class="profil" ><img src="%s" alt="image" height="150px" width="150px" id="profileimage"></div>
                                     <div class="detial">
                                        <h3>%s</h3>
                                        <p>%s</p>
                                        <table align="center">
