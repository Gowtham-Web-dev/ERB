...
print("""
        ...
        <div id="Sidebar" class="d-flex flex-column  offcanvas-md offcanvas-start " >
           <div>
            ...
            <li><a href="./FN_salarytable.py?id=%s" target="_self" id="a" style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;"><span class=" fa fa-money-bill-1-wave" style="color: #CFEEFF;"></span>Salary</a></li>
            <li><div class="dropdown">
...
for j in rec2:
    ...
    print("""
                                                            ...
                                                            """ % (j[4], j[12], j[6], j[7], j[8], j[9], j[10], j[11],issue_date1))
print("""
                            </tbody>
