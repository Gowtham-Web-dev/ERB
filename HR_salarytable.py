...
print("""
        <div id="Sidebar" class="d-flex flex-column  offcanvas-md offcanvas-start " >
           <div>
            ...
            <li><a href="./HR_salarytable.py?id=%s"" target="_self" id="a" style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;"><span class=" fa fa-money-bill-1-wave"  style="color: #CFEEFF;" ></span>Salary</a></li>
            <li><div class="dropdown">
