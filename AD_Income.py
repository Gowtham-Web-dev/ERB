    ...
    <div id="Sidebar_cover2">
        ...
        <div id="Sidebar" class="d-flex flex-column  offcanvas-md offcanvas-start " >
           <div>
            ...
            <li><a href="./AD_Income.py" id="a"style="background-color: #23395f; color: white; margin-left: -10px; margin-right: -8px; border-left:3px solid orange;" ><i class="fa fa-sack-dollar" style="color: #CFEEFF;"></i> Income</a></li>
